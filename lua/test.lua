...
-- insert into name table. name_id is auto-incremented
    local str = string.format("INSERT INTO name SET name='%s',room='%s',title='%s',status='%s',public='1',mtime='%s';",
                              con:escape(t["name"]), t["room"], t["study"], t["status"], mtime)
    print(str)
...
t["email"] = "pawsen@gmail.com"
t["name"] = "Paw Hergé Mao Æøå"
t["password"] = "$6$rounds=5000$TIT7wt1IkJoWyh5a$qraGn.ZTbCVxk/v2wZ.c6El.x/0hyLQvYbmByMgd7TwiSreJbnoY1V/RCQjpKixqqlsAY64A5QugSOHlkzm5v/"
t["phone"] = "29935611"
t["room"] = "1"
t["status"] = "normal"
t["study"] = "Unix guru"
